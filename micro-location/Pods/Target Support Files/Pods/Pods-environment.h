...
// CDSParticleFilter
#define COCOAPODS_POD_AVAILABLE_CDSParticleFilter
#define COCOAPODS_VERSION_MAJOR_CDSParticleFilter 0
#define COCOAPODS_VERSION_MINOR_CDSParticleFilter 5
#define COCOAPODS_VERSION_PATCH_CDSParticleFilter 0
