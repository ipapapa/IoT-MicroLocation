...
public class ParticleFilter {
    ...
    public ParticleFilter(int numParticles, Point[] landmarks, double width, double height) // constructor
    {
        this.numParticles = numParticles;

        particles = new Particle[numParticles];
        for (int i = 0; i < numParticles; i++) {
            particles[i] = new Particle(landmarks, width, height); //create new particles 
        }
    }
