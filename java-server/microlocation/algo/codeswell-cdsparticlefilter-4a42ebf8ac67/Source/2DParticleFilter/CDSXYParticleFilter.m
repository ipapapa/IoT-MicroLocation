...
@property (nonatomic, strong) CDSParticleFilter* filter; //filter declared of type CDSParticleFilter
@property (nonatomic, assign) double minX; //The lower limit  interval for the particle on x-axis
@property (nonatomic, assign) double maxX; //The upper limit interval for the particle on x-axis
@property (nonatomic, assign) double minY; //The lower limit interval for the particle on y-axis
@property (nonatomic, assign) double maxY; //The upper limit interval for the particle on y-axis
@property (nonatomic, assign) double noiseSigma;  //The std. variation of noise
